...
blocked_users = {}
order_counter = [1000]
provider_cooldown = {}  # { phone: until_timestamp }
...
def handle_reaction(group_id, sender, sender_name):
    ...
    # فحص الـ cooldown (10 دقائق بين كل طلب)
