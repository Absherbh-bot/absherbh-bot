...
if __name__ == "__main__":
    ...
    app.run(host="0.0.0.0", port=port, debug=False)SERVICES = {
    "1": "الخدمات الهندسية",
    "2": "الخدمات العقارية",
    "3": "الخدمات الطلابية",
    "4": "مناديب التوصيل",
...
T = {
    "ar": {
        "welcome": (
            ...
            'منصتك الذكية للتواصل مع مقدمي الخدمات في مدينتك\n'
            '━━━━━━━━━━━━━━\n'
            '1 - حائل 📍 (مدن أخرى قريباً 🔜)\n'
            '━━━━━━━━━━━━━━\n'
            'تريد تسجيل نشاطك؟ أرسل: 2\n'
            '━━━━━━━━━━━━━━\n'
            'للشكاوى والاقتراحات أرسل: 3\n'
            '━━━━━━━━━━━━━━\n'
            '🌐 اختر لغتك / Change language / زبان تبدیل کریں: 4'
        ),
        "choose_service": (
            "اختر الخدمة:\n\n"
            "1 - الخدمات الهندسية\n"
    ...
    "en": {
        "welcome": (
            ...
            'Your smart platform to connect with service providers in your city\n'
            '━━━━━━━━━━━━━━\n'
            '1 - Hail 📍 (More cities coming soon 🔜)\n'
            '━━━━━━━━━━━━━━\n'
            'Do you want to register your business? Send: 2\n'
            '━━━━━━━━━━━━━━\n'
    ...
    "ur": {
        "welcome": (
            ...
            '1 - حائل 📍 (مزید شہر جلد 🔜)\n'
            '━━━━━━━━━━━━━━\n'
            'کیا آپ اپنا کاروبار رجسٹر کرنا چاہتے ہیں؟ بھیجیں: 2\n'
            '━━━━━━━━━━━━━━\n'
...
def handle_customer(phone, msg):
    ...
    # ── شروط العميل ──
        ...
        if msg == "0":
            user_sessions[phone] = {"step": "description", "city": city, "service": service}
            send_msg(phone, f"اخترت: {service}\n\nاكتب وصفاً قصيراً:\n\n0 - رجوع ↩️")
            return
        if msg == "1":
            registered_clients.add(phone)
            save_clients()
