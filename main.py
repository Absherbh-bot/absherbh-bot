...
REGIONS = {
    "حائل": ["حائل"],  # مفعّلة ✅
    "الوسطى": ["الرياض"],  # قريباً
    "مكة المكرمة": ["مكة المكرمة", "جدة", "الطائف"],  # قريباً
    "الشرقية": ["الدمام", "الخبر", "الاحساء"],  # قريباً
    "المدينة المنورة": ["المدينة المنورة", "ينبع"],  # قريباً
    "القصيم": ["القصيم"],  # قريباً
    "تبوك": ["تبوك"],  # قريباً
    "الحدود الشمالية": ["عرعر", "رفحاء"],  # قريباً
    "الجوف": ["الجوف", "سكاكا"],  # قريباً
    "عسير": ["ابها", "خميس مشيط"],  # قريباً
    "جازان": ["جازان"],  # قريباً
    "نجران": ["نجران"],  # قريباً
    "الباحة": ["الباحة"],  # قريباً
}

ACTIVE_REGIONS = ["حائل"]  # المناطق المفعّلة فقط
